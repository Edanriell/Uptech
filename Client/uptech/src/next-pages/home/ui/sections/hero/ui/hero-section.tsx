...
// TODO
// Implement Three js slider for hero section
	...
	return (
		<section className="w-full h-[760rem] relative pl-[16rem] pr-[16rem] pb-[100rem] flex flex-col items-center justify-end mb-[80rem] tablet:ml-[32rem] tablet:mr-[32rem] tablet:rounded-[24rem] tablet:overflow-hidden tablet:h-[829rem] tablet:pl-[64rem] tablet:pr-[64rem] tablet:grow-0 tablet:shrink-0 tablet:flex-row tablet:items-end tablet:mb-[160rem] tablet:w-[unset]! tablet:gap-x-[55rem]">
			<Image
				...
				loading="eager"
			/>
			<h2 className="min-w-[358rem] font-medium text-[46rem] leading-[100%] capitalize text-center text-(--neutral-100) relative z-[20] mb-[16rem] text-balance tablet:mb-[unset] tablet:text-left tablet:text-[73rem] desktop:text-[100rem] desktop:min-w-[763rem]">
			...
			<div className="relative z-[20] tablet:flex tablet:flex-col tablet:items-center tablet:basis-[620rem] tablet:items-start desktop:basis-[427rem]">
				<p className="min-w-[358rem] font-light text-[16rem] leading-[160%] text-center text-(--neutral-100) mb-[32rem] text-balance tablet:min-w-[unset] tablet:text-left tablet:min-w-[unset] tablet:text-pretty tablet:text-[17rem] desktop:text-[18rem] desktop:text-wrap desktop:min-w-[427rem]">
